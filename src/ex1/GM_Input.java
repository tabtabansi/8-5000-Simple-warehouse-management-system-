...
public class GM_Input extends JFrame {
    static Connection con;
    static Statement sql;
    static ResultSet res;
    public void GM_input() {
        ...
        try {
            ...
            res = sql.executeQuery("select * from Warehouse_Commodity_Input");
        ...
        change.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new Input_Dialog(GM_Input.this).setVisible(true);
